 ...
 */
public class WatchlistWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.laripping.watchlistwidget.WatchlistWidget";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = WatchlistWidgetConfigureActivity.this;

            // When the button is clicked, store the string locally
            String widgetText = mAppWidgetText.getText().toString();
            saveTitlePref(context, mAppWidgetId, widgetText);

            // Call the widget provider's method to init the widget
            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
            WatchlistWidget.initWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public WatchlistWidgetConfigureActivity() {
        super();
    }
